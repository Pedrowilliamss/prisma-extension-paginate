...
export function createPaginateExtension(prisma: PrismaNamespace, options?: Partial<PaginateOptions>) {
    defaultArgs = options
...
function getPaginateFN(prisma: PrismaNamespace) {
    return async function paginate<T, A extends PaginateArgs<T>>(
        this: T,
        args: A,
